...
import { LayoutDashboard, BookOpen, Settings, Compass, KeyRound, Bell, GanttChartSquare, Globe, BarChart2, Image as ImageIcon, Share2 } from "lucide-react";
...
export function Sidebar({ className }: SidebarProps) {
  ...
  const websiteNav = [
    ...
    { name: "Impact Numbers", href: "/impact", icon: BarChart2 },
    { name: "Client Logos", href: "/client-logos", icon: ImageIcon },
  ...
  return (
    ...
    >
      ...
      <nav className="flex-1 space-y-1 px-4 py-6 overflow-y-auto">
        ...
        <div className="px-2 mt-6 mb-2 text-xs font-semibold tracking-wider text-[#94A3B8] uppercase">
          WEBSITE CONTENT
        </div>
        {websiteNav.map((item) => {
