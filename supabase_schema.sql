...
CREATE TABLE IF NOT EXISTS projects (
    ...
    reel_section JSONB NOT NULL DEFAULT '{"enabled": false, "items": []}',
...
ALTER TABLE projects ADD COLUMN IF NOT EXISTS reel_section JSONB NOT NULL DEFAULT '{"enabled": false, "items": []}';
ALTER TABLE projects ADD COLUMN IF NOT EXISTS section_visibility JSONB NOT NULL DEFAULT '{}';
